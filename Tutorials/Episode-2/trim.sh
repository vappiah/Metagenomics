...
porechop -t 4 -i data/bulk_top.fastq.gz  -o trimmed/bulk_top.fastq.gz --format fastq.gz
porechop -t 4 -i data/rhizosphere_top.fastq.gz  -o trimmed/rhizosphere_top.fastq.gz --format fastq.gz
